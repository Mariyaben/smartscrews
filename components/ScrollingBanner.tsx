...
export default function ScrollingBanner() {
  ...
  return (
    ...
    >
      <div className="pt-3 sm:pt-4 lg:pt-5 pb-16 sm:pb-20 lg:pb-24 xl:pb-32">
        <div className="flex animate-scroll-horizontal whitespace-nowrap">
          {duplicatedBadges.map((badge, index) => (
            ...
            >
              <span className="text-xs sm:text-sm lg:text-base font-semibold text-[#213f51] tracking-wide whitespace-nowrap px-4 sm:px-6 lg:px-8">
                {badge}
              </span>
              <span className="text-[#2f5a65] text-base sm:text-lg px-1 sm:px-2">•</span>
            </div>
          ))}
        </div>
      </div>
