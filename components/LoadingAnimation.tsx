...
export default function LoadingAnimation({ fullScreen = true, message = 'Loading...' }: LoadingAnimationProps) {
  const wrapperClass = fullScreen
    ? 'fixed inset-0 z-[9999] flex items-center justify-center bg-[#fffffe]'
...
export function PageLoader() {
  ...
  useEffect(() => {
    // After 3 seconds, allow content to show
        ...
        >
          <div className="relative w-full h-full">
              ...
              {letters.map((letter, index) => {
                ...
                return (
                  <motion.span
                    ...
                    className="absolute text-7xl font-bold text-[#0e7888]"
                    style={{
                      left: '50%',
                      top: '50%',
                    }}
            ...
            >
              <svg
                viewBox="0 0 100 100"
                className="w-20 h-20 text-[#0e7888]"
                fill="currentColor"
              >
            ...
            >
              <motion.div
                className="text-7xl font-light text-[rgba(33,63,81,0.3)] mb-3"
                animate={{
                  opacity: [0.3, 0.5, 0.3],
                }}
                transition={{
