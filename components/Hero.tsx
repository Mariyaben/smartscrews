              ...
              <div className="flex flex-col h-full">
                ...
                <div className="flex flex-col gap-2 px-6 pt-6 pb-6">
                  ...
                  <motion.a
                    ...
                    className="flex items-center justify-center gap-2 hover:opacity-80 transition-opacity whitespace-nowrap cursor-pointer touch-manipulation pt-2"
                    style={{ 
                      color: '#ffffff',
                      fontFamily: 'var(--font-geist-sans), system-ui, -apple-system, sans-serif',
                      fontWeight: 300,
                  ...
                  <motion.a
                    ...
                    className="flex items-center justify-center gap-2 hover:opacity-80 transition-opacity cursor-pointer touch-manipulation"
                    style={{ 
                      color: '#ffffff',
                      pointerEvents: 'auto',
                      minHeight: '44px'
